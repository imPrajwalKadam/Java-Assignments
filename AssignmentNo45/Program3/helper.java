...
class ArrayDemo 
 { 
   ...
   //Discription  : this function accept  N numbers from user and Display that number who are even and  divisible by 5  
   //Author       : Prajwal Kadam
   //Date         : 1 jun 2021
   ///////////////////////////////////////////////////////////////
    public void Difference(int Arr[],int iNo) 
    { 
        System.out.println("This  elements is even And Divisible by 5:");
        for(int i = 0;i<iNo;i++)
        {
